...
class Meridian:
  ...
  def _validate_time_invariants(self):
    ...
    # TODO: b/379885126 - Remove this check. Some models assign dummy values to
    # required controls and this check fails. In our codebase, they all happen
    # to be national models.
